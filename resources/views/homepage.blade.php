...
@section('content')
    ...
    <header
        class="relative flex min-h-[80svh] flex-col justify-center px-12 pt-0 pb-0 bg-surface dark:bg-inverse-surface overflow-hidden">
    ...
    <section
        class="py-16 px-12 bg-surface-container-low dark:bg-inverse-surface/50 border-t border-b border-outline-variant">
        <div class="max-w-7xl mx-auto">
            <h2
                class="text-3xl font-extrabold tracking-tight text-on-surface dark:text-surface-container-high mb-12 text-center">
                Why Choose STEM?</h2>

            <div class="flex flex-col border-t border-outline-variant/60">
                <div
                    class="flex flex-col md:flex-row items-center gap-6 py-8 border-b border-outline-variant/60 group hover:bg-surface/50 dark:hover:bg-surface-container-low/30 transition-colors px-4 rounded-lg">
                    <div
                        class="text-4xl font-black text-primary dark:text-primary-fixed-dim opacity-30 w-16 md:text-left text-center">
                        01</div>
                    <div class="flex-grow grid grid-cols-1 md:grid-cols-2 gap-4">
                        <h3
                            class="text-xl font-bold text-on-surface dark:text-surface-container-high flex items-center justify-center md:justify-start">
                            Critical Thinking</h3>
                        <p
                            class="text-base text-on-surface-variant dark:text-outline-variant flex items-center text-center md:text-left">
                            Developing the ability to analyze and solve complex problems logically.</p>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="flex-grow grid grid-cols-1 md:grid-cols-2 gap-4">
                        <h3
                            class="text-xl font-bold text-on-surface dark:text-surface-container-high flex items-center justify-center md:justify-start">
                            Future-Ready Careers</h3>
                        <p
                            class="text-base text-on-surface-variant dark:text-outline-variant flex items-center text-center md:text-left">
                            Preparing for the fastest-growing and highest-impact job markets globally.</p>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="flex-grow grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <p
                            class="text-base text-on-surface-variant dark:text-outline-variant flex items-center text-center md:text-left">
                            Empowering the next generation to build better technology, software, and systems.</p>
                    </div>
                </div>
            </div>
        </div>
