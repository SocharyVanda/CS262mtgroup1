    ...
    <div class="page-wrap">
        ...
        <div class="section-gap">
            ...
            <div class="news-grid">
                ...
                <a class="news-card" href="#">
                    <div class="news-card-thumb thumb-tech">💻</div>
                ...
                <a class="news-card" href="#">
                    <div class="news-card-thumb thumb-math">📐</div>
                    <div class="news-card-body">
                ...
                <a class="news-card" href="#">
                    <div class="news-card-thumb thumb-env">🌿</div>
                    <div class="news-card-body">
                ...
                <a class="news-card" href="#">
                    <div class="news-card-thumb thumb-eng">⚙️</div>
                    <div class="news-card-body">
                ...
                <a class="news-card" href="#">
                    <div class="news-card-thumb thumb-health">🧬</div>
                    <div class="news-card-body">
        ...
        <div class="section-gap">
            ...
            <div class="news-grid">
                ...
                <a class="news-card" href="#">
                    <div class="news-card-thumb thumb-science">🔭</div>
                    <div class="news-card-body">
        ...
        <div class="newsletter-bar">
            <div class="newsletter-text">
                ...
                <p>Get the latest STEM Cambodia news delivered to your inbox weekly.</p>
            </div>
